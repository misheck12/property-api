...
RSpec.describe 'api/v1/properties', type: :request do
  ...
  path '/api/v1/properties/search_by_owner' do

    get('search_by_owner property') do
  ...
  path '/api/v1/properties/search_by_filters' do

    get('search_by_filters property') do
      response(200, 'successful') do
  ...
  path '/api/v1/properties/search_by_address' do

    get('search_by_address property') do
      response(200, 'successful') do
